...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--test_epoch_freq', type=int, default=1, help='frequency of testing at the end of epochs')
        ...
        parser.add_argument('--seed', type=int, default=1, help='training seed to use')
