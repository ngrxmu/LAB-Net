...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='unet_256', help='selects first model to use for netG')
        ...
        parser.add_argument('--model', type=str, default='madain',
        ...
        parser.add_argument('--norm_mean', type=list, default=[0.,0.,0.])
        parser.add_argument('--norm_std', type=list, default=[1.,1.,1.])
        parser.add_argument('--size_w', type=int, default=640, help='w of result image')
        parser.add_argument('--size_h', type=int, default=480, help='h of result image')
        parser.add_argument('--down_w', type=int, default=256, help='w of downsample size on LSA module')
        parser.add_argument('--down_h', type=int, default=256, help='h of downsample size on LSA module')
